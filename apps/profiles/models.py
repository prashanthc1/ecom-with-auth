...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"), max_length=30, default="+971505000000")
    ...
    country = CountryField(verbose_name=_("Country"), default="AE", blank=False, null=False)
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Dubai", blank=False, null=False)
